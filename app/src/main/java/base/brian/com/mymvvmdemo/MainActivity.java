...
import base.brian.com.mymvvmdemo.news.NewsListFragment;
import base.brian.com.mymvvmdemo.utils.ViewUtils;
...
public class MainActivity extends RxAppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setVariable(base.brian.com.mymvvmdemo.BR.viewModel,new MainViewModel(this));
        ...
        ((AppBarLayout)findViewById(R.id.appBarLayout)).addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                Log.i(tag,"height:"+height+" appBarLayout.getHeight():"+appBarLayout.getHeight()+" actionbar.height:"+getSupportActionBar().getHeight()+" status.height:"+ViewUtils.getStatusBarHeight(MainActivity.this));
                int alpha = 255 * (0 - verticalOffset) / height;
                Log.i(tag,"verticalOffset:"+verticalOffset+" alpha:"+alpha);
