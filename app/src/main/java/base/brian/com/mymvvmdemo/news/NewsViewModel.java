package base.brian.com.mymvvmdemo.news;
...
import base.brian.com.mymvvmdemo.BrianApp;
...
import base.brian.com.mymvvmdemo.network.retrofit.RetrofitProvider;
...
public class NewsViewModel implements ViewModel {
    public static final String TOKEN_TOP_NEWS_FINISH = "token_top_news_finish" + BrianApp.sPackageName;
